...
namespace TowerDefense.GamePlay
{
    ...
    {
        public BasicTurret(Texture2D texture,Texture2D bulletTexture, int damage, int price,float shootSpeed, float shootRate, int range, int xPos, int yPos, IProjectileHandler handler, List<Enemy> enemies)
        {
